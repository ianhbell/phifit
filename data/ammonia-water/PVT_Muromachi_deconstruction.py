...
data = {
  ...
  'data': {  # x_NH3 (molar), rho (kg/m3) (aligned with pressure)
    ...
    0.9102: [581.9, 569.2, 555.0, 538.9, 520.1, 497.6, 484.1, 468.5, 450.0, 426.9, np.nan, np.nan, np.nan, np.nan, np.nan],
    1.0000: [551.9, 538.3, 523.1, 505.9, 485.8, 461.5, 446.9, 430.2, 410.1, 384.9, 350.9, np.nan, np.nan, np.nan, np.nan]
  }
  }
}
